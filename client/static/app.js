...
const HELP_CONTENT = {
    ...
    'lesson1': {
        ...
        body: `
            ...
            <div class="card" style="background: rgba(var(--color-accent-rgb), 0.05); border-left: 4px solid var(--color-accent); margin-top: 20px;">
                <h3 style="color: var(--color-accent); display: flex; align-items: center; gap: 8px;">
